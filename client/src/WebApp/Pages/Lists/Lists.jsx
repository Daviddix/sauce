...
function Lists() {
  ...
  async function getInformationAboutList(){
    ...
    try{
      const rawFetch = await fetch(`https://sauce-dev.onrender.com/app/list/movies/${movieListId}`, {
            credentials: "include"
        })
  ...
  async function deleteList(id){
    try{
    const rawFetch = await fetch(`https://sauce-dev.onrender.com/app/list/movies/${movieListId}/l`,{
      method : "DELETE",
      credentials : "include"
    })
    const fetchInJson = await rawFetch.json()
