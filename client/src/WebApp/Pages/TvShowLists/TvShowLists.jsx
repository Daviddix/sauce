...
function TvShowLists(){
    ...
    async function getInformationAboutList(){
        ...
        try{
            const rawFetch = await fetch(`https://sauce-dev.onrender.com/app/list/tv/${tvShowListId}`, {
                credentials: "include"
            })
    ...
    async function deleteList(id){
        try{
            const rawFetch = await fetch(`https://sauce-dev.onrender.com/app/list/tv/${tvShowListId}/l`,{
                method : "DELETE",
                credentials : "include"
              }) 
            const fetchInJson = await rawFetch.json()
